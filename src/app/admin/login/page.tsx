      ...
      <div className="w-full max-w-md">
        ...
        <div className="bg-[#08080c] border border-[#1a1a22] rounded-sm p-8 shadow-2xl">
          ...
          <button
            ...
            disabled={loading}
            className="w-full flex items-center justify-center gap-3 bg-white text-black font-medium py-3 px-4 rounded-sm hover:bg-zinc-100 transition-colors mb-4 disabled:opacity-50"
          >
          ...
          <div className="flex items-center gap-3 my-4">
            <div className="flex-1 h-px bg-[#1a1a22]" />
            <span className="text-[#4A4945] text-xs">or</span>
            <div className="flex-1 h-px bg-[#1a1a22]" />
          </div>
